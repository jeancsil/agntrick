...
class YouTubeTranscriptTool(Tool):
    ...
    This tool fetches video transcripts using the youtube-transcript-api,
    ...
    def description(self) -> str:
        ...
        return (
            ...
            "Returns the full transcript text with timestamps."
        )
    ...
    def _extract_video_id(self, url_or_id: str) -> str | None:
        ...
        Args:
            url_or_id: A YouTube URL in any supported format, or a
