...
Troubleshooting:
    ...
    - "Cannot convert format": Install ffmpeg-python: `pip install ffmpeg-python` (requires ffmpeg).
...
class AudioTranscriber:
    ...
    This class provides async audio transcription using Groq's Whisper API.
    It supports multiple audio formats and automatic conversion for unsupported formats.
    ...
    Example:
        >>> transcriber = AudioTranscriber()
        >>> result = await transcriber.transcribe_audio("/path/to/audio.ogg")
        >>> print(result)
    """
